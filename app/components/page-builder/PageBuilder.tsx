        ...
        <div className="flex items-center space-x-2">
          <button
            ...
            className={`inline-flex items-center px-3 py-1.5 text-sm rounded-md ${
              showPreview ? 'bg-purple-100 text-purple-700 dark:bg-purple-900 dark:text-purple-300' : 'text-gray-600 dark:text-gray-400 hover:bg-gray-100 dark:hover:bg-gray-700'
            }`}
          >
          ...
          <div className="flex border-b border-gray-200 dark:border-gray-700">
            <button
              ...
              className={`flex-1 px-3 py-2 text-xs font-medium ${
                activeTab === 'components' ? 'text-purple-600 border-b-2 border-purple-600' : 'text-gray-500 hover:text-gray-700'
              }`}
            >
              <Squares2X2Icon className="h-4 w-4 mx-auto mb-0.5" />
              Add
            </button>
            <button
            ...
            >
              <Cog6ToothIcon className="h-4 w-4 mx-auto mb-0.5" />
              Edit
            </button>
            <button
              onClick={() => setSidebarTab('theme')}
              className={`flex-1 px-3 py-2 text-xs font-medium ${
                activeTab === 'theme' ? 'text-purple-600 border-b-2 border-purple-600' : 'text-gray-500 hover:text-gray-700'
              }`}
            >
              <PaintBrushIcon className="h-4 w-4 mx-auto mb-0.5" />
              Theme
            </button>
          </div>
