          ...
          <div className="grid grid-cols-1 gap-6 sm:grid-cols-2 lg:grid-cols-3">
            {mockOrganizations.map((org) => (
              <Link
                ...
                className="group relative bg-white border border-gray-200 rounded-lg shadow-sm hover:shadow-md transition-shadow p-6"
              >
                ...
                <div className="mt-6 grid grid-cols-2 gap-4">
                  <div className="flex items-center">
                    ...
                    <span className="text-sm text-gray-600">{org.memberCount} members</span>
                  </div>
                  <div className="flex items-center">
                    <CurrencyDollarIcon className="h-4 w-4 text-gray-400 mr-2" />
                    <span className="text-sm text-gray-600">{org.dealsCount} deals</span>
                  </div>
                </div>
